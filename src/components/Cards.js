...
const Card = (props) =>{
    ...
    let highTemp = Math.round(Math.max(...props.contextProps.map(e=>e.main.temp_max)));
    let lowTemp = Math.round(Math.min(...props.contextProps.map(e=>e.main.temp_min)));
...
const MainCard = (props) => {
    let highTemp = Math.round(Math.max(...props.contextProps.apiData[0].map(e=>e.main.temp_max)));
    let lowTemp = Math.round(Math.min(...props.contextProps.apiData[0].map(e=>e.main.temp_min)));
    ...
    <MainCardContainer>
        ...
        <div className='bottom-grid'>
            {
                props.contextProps.apiData[0].map(e=>(
